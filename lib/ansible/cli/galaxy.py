...
class GalaxyCLI(CLI):
    ...
    def init_parser(self):
        ...
        cinstall_parser.add_argument('-p', '--collections-path', dest='collections_path', required=True,
                                     help='The path to the directory containing your collections. Use one of the configured paths or '
                                          'the directory containing the playbook that references the collection. This does not add '
                                          'the path to the configured paths.')
